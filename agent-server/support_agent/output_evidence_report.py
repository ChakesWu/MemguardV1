...
from .output_evidence import ExplicitCitation, extract_explicit_citations
...
def _order_evidence(repository: SupportRepository, tenant_id: str, memory_id: str) -> MemoryEvidence | None:
    ...
    return MemoryEvidence(
        ...
        created_at=order.source_updated_at or order.delivered_at,
        verified_at=order.verified_at,
        conflict_status=ConflictStatus(order.conflict_status),
